export function scheduledInterviewEmailTemplate(
  ...
  const bodyForCandidate = `<b>Dear ${candidate_name}</b><br/><p>Your interview has been scheduled. Please review the details below and ensure you are prepared:</p>
    <ul>
        <li><strong>Date</strong> ${new Date(scheduledAt).getDate()}</li>
        <li><strong>Time:</strong> ${new Date(scheduledAt).getTime()}</li>
...
export function rescheduledInterviewEmailTemplate(
  ...
  <ul>
    <li><strong>New Date:</strong> ${new Date(scheduledAt).getDate()}</li>
    <li><strong>New Time:</strong> ${new Date(scheduledAt).getTime()}</li>
    <li><strong>Location:</strong> ${location}</li>
  </ul>
...
export function canceledInterviewEmailTemplate(
  candidate_name: string,
) {
